...
if (john.average > mark.average) {
    console.log(john.fullname + '\'s family pays higher tipes with an average of $' + john.average) 
}else if (mark.average > john.average) {
    console.log(mark.fullName + '\'s family pays higher tipes with an average of $' + mark.average)
}